...
const LoginPage = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (token && refreshToken) {
        ...
        setAnnouncement({ message: 'Login successful! Redirecting...', isSuccess: true });
  ...
  return (
    <div className={`min-h-screen flex items-center justify-center p-6 transition-colors duration-300 ${bgMain}`}>
      {announcement && (
        <AnnouncementBox
      ...
      <div className={`max-w-md w-full rounded-[2.5rem] border p-10 transition-all duration-300 ${cardBg}`}>
      ...
      <div className="fixed bottom-10 flex gap-6 opacity-30 text-[10px] font-black uppercase tracking-[0.2em]">
