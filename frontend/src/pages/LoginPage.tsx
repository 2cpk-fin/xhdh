...
import { Mail, Lock, LogIn, UserPlus, ShieldCheck, Star } from 'lucide-react';
...
const LoginPage = () => {
  ...
  return (
    <div className={`min-h-screen flex flex-col items-center justify-center p-6 transition-colors duration-300 relative overflow-hidden ${bgMain}`}>
      ...
      <div className="relative z-10 max-w-md w-full flex flex-col items-center gap-6">
        ...
        {/* Login Card */}
        <div className={`w-full rounded-[2.5rem] border p-10 transition-all duration-300 ${cardBg}`}>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div className="relative group">
              ...
              <input
                ...
                className={`w-full py-4 pl-12 pr-4 rounded-2xl border outline-none focus:ring-2 focus:ring-purple-500/20 transition-all font-medium ${inputBg} ${textColor}`}
            ...
            <button
              type="submit"
              className="w-full bg-purple-600 hover:bg-purple-500 text-white font-black py-5 rounded-2xl flex items-center justify-center gap-3 transition-all active:scale-95 shadow-xl shadow-purple-500/20 mt-4"
            >
          ...
          <div className="mt-8 pt-8 border-t border-zinc-500/10 text-center">
            <p className="text-sm font-medium opacity-50">
              ...
              <Link to="/register" className="text-purple-500 font-black hover:underline underline-offset-4">
                Join now <UserPlus className="w-4 h-4 inline-block ml-1" />
              </Link>
            </p>
          </div>
        </div>
        <div className="flex flex-wrap justify-center gap-6 opacity-30 text-[10px] font-black uppercase tracking-[0.2em]">
          <span>© 2026 University Ranking</span>
          <span className="flex items-center gap-1">
            <Star className="w-3 h-3 fill-current" /> Verified Voting
          </span>
        </div>
