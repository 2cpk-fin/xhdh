            ...
            <div className="max-w-5xl mx-auto space-y-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 space-y-8">
                  <section className={`${cardBg} rounded-[2rem] p-8 shadow-xl border transition-colors duration-300`}>
                    ...
                    <div className="space-y-4">
                      {[
                        ...
                        { id: 'sound', icon: Volume2, title: 'Sound Effects', desc: 'Interactive audio feedback', state: soundEnabled, toggle: setSoundEnabled, color: 'text-green-500' },
                          ...
                          <div key={item.id} className={`p-5 rounded-2xl border transition-colors ${isDark ? 'bg-zinc-900/40 border-zinc-800' : 'bg-zinc-50 border-zinc-100'} flex items-center justify-between`}>
                ...
                <div className="space-y-8">
                  <section className={`${cardBg} rounded-[2rem] p-8 shadow-xl border transition-colors duration-300`}>
                    ...
                    <div className="space-y-4">
                      <button className={`w-full flex items-center gap-3 p-3 rounded-xl hover:bg-zinc-500/10 transition-colors ${textColor}`}>
                        <User className="w-5 h-5 opacity-50" />
                        <span className="text-sm font-bold">Profile Details</span>
                      </button>
                      <button className="w-full flex items-center gap-3 p-3 rounded-xl hover:bg-zinc-500/10 transition-colors text-red-500">
                  ...
                  <section className={`${cardBg} rounded-[2rem] p-8 shadow-xl border bg-gradient-to-br from-purple-500/5 to-transparent transition-colors duration-300`}>
                    <Shield className="w-10 h-10 text-cyan-500 mb-4" />
                    <h3 className={`font-black text-lg ${textColor} mb-2`}>Data Privacy</h3>
                    <p className={`text-xs ${subTextColor} leading-relaxed mb-6`}>
