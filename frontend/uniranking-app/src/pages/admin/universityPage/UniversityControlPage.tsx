        ...
        <div className="max-w-6xl mx-auto px-6 py-8">
            ...
            <div className="flex items-center justify-between mb-8">
                ...
                <button
                    ...
                    className="flex items-center px-5 py-2.5 bg-green-500 text-white rounded-xl font-bold shadow-sm hover:bg-green-600 transition-all hover:scale-105 active:scale-95"
                >
            ...
            {/* University List */}
            <div className="bg-zinc-50/50 border border-zinc-200 rounded-3xl p-6 shadow-sm transition-all">
